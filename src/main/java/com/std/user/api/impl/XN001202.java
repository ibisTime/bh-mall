...
import com.std.user.dto.req.XN001202Req;
...
public class XN001202 extends AProcessor {
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN001202Req.class);
