...
import com.std.user.dto.req.XN805069ZReq;
 ...
 * @history:
 */
public class XN805069Z extends AProcessor {
    private IUserAO userAO = SpringContextHolder.getBean(IUserAO.class);

    private XN805069ZReq req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN805069ZReq.class);
