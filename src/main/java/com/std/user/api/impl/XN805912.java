...
import com.std.user.dto.req.XN805912Req;
 ...
 * @history:
 */
public class XN805912 extends AProcessor {

    private IUserAO userAO = SpringContextHolder.getBean(IUserAO.class);

    private XN805912Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN805912Req.class);
