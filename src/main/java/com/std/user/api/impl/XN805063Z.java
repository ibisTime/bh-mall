...
import com.std.user.dto.req.XN805063ZReq;
 ...
 * @history:
 */
public class XN805063Z extends AProcessor {
    private IUserAO userAO = SpringContextHolder.getBean(IUserAO.class);

    private XN805063ZReq req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN805063ZReq.class);
