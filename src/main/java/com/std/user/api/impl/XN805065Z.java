...
import com.std.user.dto.req.XN805065ZReq;
 ...
 * @history:
 */
public class XN805065Z extends AProcessor {
    private IUserAO userAO = SpringContextHolder.getBean(IUserAO.class);

    private XN805065ZReq req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN805065ZReq.class);
