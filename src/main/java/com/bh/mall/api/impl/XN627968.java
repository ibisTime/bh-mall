...
import com.bh.mall.dto.req.XN627968Req;
 ...
 * @history:
 */
public class XN627968 extends AProcessor {
    private ISYSConfigAO sysConfigAO = SpringContextHolder
        .getBean(ISYSConfigAO.class);

    private XN627968Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN627968Req.class);
