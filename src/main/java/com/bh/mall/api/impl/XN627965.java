...
import com.bh.mall.dto.req.XN627965Req;
 ...
 * @history:
 */
public class XN627965 extends AProcessor {
    private ISYSConfigAO sysConfigAO = SpringContextHolder
        .getBean(ISYSConfigAO.class);

    private XN627965Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN627965Req.class);
