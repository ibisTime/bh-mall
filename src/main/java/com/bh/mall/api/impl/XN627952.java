...
import com.bh.mall.dto.req.XN627952Req;
 ...
 * @history:
 */
public class XN627952 extends AProcessor {
    private ISYSDictAO sysDictAO = SpringContextHolder
        .getBean(ISYSDictAO.class);

    private XN627952Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN627952Req.class);
