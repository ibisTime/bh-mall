...
import com.bh.mall.dto.req.XN627923Req;
 ...
 * @history:
 */
public class XN627923 extends AProcessor {
    private ISYSRoleAO sysRoleAO = SpringContextHolder
        .getBean(ISYSRoleAO.class);

    private XN627923Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN627923Req.class);
