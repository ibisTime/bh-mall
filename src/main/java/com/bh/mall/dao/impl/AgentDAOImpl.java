...
public class AgentDAOImpl extends AMybatisTemplate implements IAgentDAO {
    ...
    public void updateSq(Agent data) {
        super.update(NAMESPACE.concat("update_sq"), data);
    }

    @Override
    public void updateSj(Agent data) {
        super.update(NAMESPACE.concat("update_sj"), data);
    }

    @Override
    public void updateImpower(Agent data) {
        super.update(NAMESPACE.concat("update_is_impower"), data);
    }

    @Override
    public void updaterTrader(Agent data) {
        super.update(NAMESPACE.concat("update_is_trader"), data);
    }
