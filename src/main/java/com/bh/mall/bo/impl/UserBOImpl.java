...
public class UserBOImpl extends PaginableBOImpl<User> implements IUserBO {
    ...
    //
    // /**
    // * @see com.bh.mall.bo.IUserBO#checkIdentify(java.lang.String,
    ...
    //
    // @Override
    // public void refreshStatus(String userId, EUserStatus status, String
    // updater,
    // String remark) {
    // if (StringUtils.isNotBlank(userId)) {
    // User data = new User();
    ...
    //
    // /**
    // * @see com.bh.mall.bo.IUserBO#doCheckOpenId(java.lang.String,
