...
INSERT INTO `tsys_menu_role` (`role_code`,`menu_code`,`updater`,`update_datetime`,`remark`) VALUES ('SR201600000000000005','SM2016071923410614051','admin',now(),NULL);
...
INSERT INTO `tsys_menu_role` (`role_code`,`menu_code`,`updater`,`update_datetime`,`remark`) VALUES ('SR201600000000000004','SM2016070521454563349','admin',now(),NULL);
...
INSERT INTO `tsys_menu_role` (`role_code`,`menu_code`,`updater`,`update_datetime`,`remark`) VALUES ('SR201600000000000004','SM2016071923410614051','admin',now(),NULL);
/*
...
/*
-- Query: SELECT code,name,type,url,order_no,updater,now() as update_datetime,remark,parent_code,kind FROM tsys_menu where update_datetime > '2016-08-30 00:00:00'
LIMIT 0, 50000
