...
*/
INSERT INTO `tsys_config` (`to_system`,`ckey`,`cvalue`,`note`,`updater`,`update_datetime`,`remark`) VALUES ('8','cswDescription','城市网介绍','城市网介绍','admin',now(),NULL);
/*
